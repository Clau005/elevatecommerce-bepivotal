...
@section('title', 'Create Testing Product')
...
<div class="container mx-auto px-4 py-8">
    ...
    <h1 class="text-3xl font-bold text-gray-900 mb-6">Create Testing Product</h1>

    <x-core::card>
        <form action="{{ route('admin.testing-purchasables.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('compare_at_price') border-red-500 @enderror">
