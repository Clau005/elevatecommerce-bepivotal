<x-app pageTitle="Edit Channel" title="Edit Channel - Admin" description="Edit sales channel">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Update channel settings</p>
                </div>
        ...
        {{-- Form --}}
        <form method="POST" action="{{ route('admin.settings.channels.update', $channel) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="handle" 
                           id="handle" 
                           value="{{ old('handle', $channel->handle) }}"
                ...
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input type="checkbox" 
                               ...
                               id="default" 
                               value="1"
                               {{ old('default', $channel->default) ? 'checked' : '' }}
