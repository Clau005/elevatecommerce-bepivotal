...
class CheckoutRulesSettingsSection extends SettingsSection
{
    ...
    {
        return 'Configure shipping, payment, and checkout validation rules';
    }
    ...
    {
        return route('admin.settings.show', 'checkout-rules');
    }
