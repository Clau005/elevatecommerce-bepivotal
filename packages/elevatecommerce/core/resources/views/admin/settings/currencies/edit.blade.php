...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Update currency settings</p>
        </div>
    </div>

    <form action="{{ route('admin.settings.currencies.update', $currency) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center">
                    <input 
                        ...
                        name="is_enabled" 
                        value="1"
                        {{ old('is_enabled', $currency->is_enabled) ? 'checked' : '' }}
                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    >
