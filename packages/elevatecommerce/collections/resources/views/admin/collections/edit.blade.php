    ...
    <form action="{{ route('admin.collections.update', $collection) }}" method="POST" class="space-y-6">
            ...
            <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="image" value="{{ old('image', $collection->image) }}">
                        <div 
                            data-media-picker
                            data-input-name="image"
                            data-type="images"
                            data-label="Upload Image"
                            data-initial-value="{{ old('image', $collection->image) }}"
                        ></div>
                    ...
                    >{{ old('description', $collection->description) }}</x-core::richtext>
                    ...
                    <div>
                        ...
                        <select name="template_id" id="template_id" required
                            ...
                            @foreach(\ElevateCommerce\Editor\Models\Template::where('model_type', 'ElevateCommerce\Collections\Models\Collection')->get() as $template)
                    ...
                    <div>
                        ...
                        <input type="number" name="per_page" id="per_page" value="{{ old('per_page', $collection->per_page ?? 12) }}" min="1" max="100"
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
            <div class="p-6">
                ...
                @php
                    $availableFilters = \ElevateCommerce\Collections\Models\CollectionFilter::with('values')
                        ->orderBy('sort_order')
                        ->get();
