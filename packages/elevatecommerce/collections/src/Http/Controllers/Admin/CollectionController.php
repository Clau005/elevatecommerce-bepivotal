...
namespace ElevateCommerce\Collections\Http\Controllers\Admin;
...
class CollectionController extends Controller
{
    ...
    public function create()
    {
        ...
        $templates = \ElevateCommerce\Editor\Models\Template::where('model_type', 'ElevateCommerce\Collections\Models\Collection')
            ->get();
    ...
    public function addItem(Request $request, Collection $collection)
    {
        ...
        if ($mode === 'smart') {
            ...
            // Get items with these tags dynamically
            $ids = [];
            
            // Check if the class exists and has a tags relationship
            if (class_exists($type)) {
                try {
                    ...
                    // Model doesn't have tags relationship, return empty
                    $ids = [];
                }
            }
        } else {
